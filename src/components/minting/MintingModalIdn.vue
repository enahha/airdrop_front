<template>
  <q-dialog v-model="MintingModalIdn" persistent>
    <q-card>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <section class="sec01">
                <h5>tukar pembayaran WTEC dengan {{ payCurrencySymbol }}</h5>
                ...
                <button class="nextBtn btn" @click="goMinting">Buat pembayaran</button>
              </section>
            </div>
          </div>
        </div>
