<template>
      ...
      <section class="sec01 full_bg">
        ...
        <div class="box">
          ...
          <div>
            ...
            &nbsp;
            <!-- 홀더인증후 버튼-->
            <button v-if="getWalletAddress" @click="showAirdropApplyModal()" class="btn btn-airdrop" data-toggle="modal" disabled>펑키콩즈 에어드랍 신청하기</button>
            <!-- //홀더인증후  버튼-->
          </div>
        </div>
      </section>
    ...
    <div class="sns">
      <ul>
        <li><a href="https://blog.naver.com/punkvism" target="_blank"><img src="images/sns_icon1.png" alt="깃허브"></a></li>
				...
				<li><a href="https://x.com/punkvism" target="_blank"><img src="images/sns_icon5.png" alt="X"></a></li>
  ...
  <!-- 렛저 모바일 안내 -->
  <q-dialog v-model="ledgerGuideMobile">
    <q-card style="width: 900px !important; height: auto; max-width: 850px !important">
      <div class="modal-1 fade-1 inner" id="wallet_confirm">
        <div class="modal-dialog-1 modal-dialog-centered-1">
        <div class="modal-content-1">
          ...
          <div class="modal_body">
            <button type="button" @click="ledgerGuideMobile = false" class="modal_close" data-dismiss="modal"><i class="xi-close-thin"></i></button>
            <p class="icons"><i class="xi-warning"></i></p>
            <h4>메타마스크에 하드웨어 지갑 추가 후<br> 메타마스크를 통해 연결해주세요.<br /></h4>
            <div class="apply_btn mt40">
              <button @click="ledgerGuideMobile = false" class="btn btn-holder s" data-dismiss="modal">확인</button>
            </div>
          </div>
        </div>
        </div>
  ...
  <!-- 렛저 pc 안내 -->
  <q-dialog v-model="ledgerGuidePc">
    <q-card style="width: 900px !important; height: auto; max-width: 850px !important">
      <div class="modal-1 fade-1 inner" id="wallet_confirm">
        <div class="modal-dialog-1 modal-dialog-centered-1">
        <div class="modal-content-1">
          ...
          <div class="modal_body">
            <button type="button" @click="ledgerGuidePc = false" class="modal_close" data-dismiss="modal"><i class="xi-close-thin"></i></button>
            <p class="icons"><i class="xi-warning"></i></p>
...
export default defineComponent({
  ...
  methods: {
    ...
    handleConnectWallet(walletType) {
      ...
      if(walletType == 'ledger') {
        if(this.smallSize){
          this.ledgerGuideMobile = true
          return
        }
        this.ledgerGuidePc = true
        // 확인 후 지갑연결 실행
      }
    },
    // 검색
    ...
    async connectMetaMaskWallet() {
            ...
            if (typeof window.ethereum !== 'undefined') {
              ...
              // location.href = 'https://metamask.app.link/dapp/https://punkykongz.com'
            }
...
/////////////////////////////////////////////////////////////////
    async connectPhantomWallet() {
      ...
      const getProvider = () => {
        ...
        window.open('https://phantom.app/ul/browse/https%3A%2F%2Fpunkykongz.com?ref=https%3A%2F%2Fmyapp.com')
      }
...
/////////////////////////////////////////////////////////////////
    ...
    async connectDcentWallet() {
      if (this.$q.platform.is.desktop) {      // pc일 경우
        ...
        //
        // this.$noti(this.$q, this.$t('MetaMask is not installed.'))
        const linkUrl = encodeURIComponent("https://punkykongz.com")   // 메인넷일 경우
