  ...
  <div class="main_container page-default">
    <div>
      <div v-if="getWalletAddress" class="header">
        ...
        <a class="wallet" @click.prevent="disconnectMetamaskWallet()">
      ...
      <div v-else class="header">
        <h1 class="logo"><img src="images/logo.png"></h1>
        <a class="wallet" @click.prevent="connectMetaMaskWallet()">
          <!-- <img src="images/wallet_icon.png" alt=""> -->
          <img src="logo/logo_metamask.png" width="30" alt="">
      ...
      <!-- 테스트용 -->
      <div class="text-white">getWalletType: {{ getWalletType }}</div>
      <div class="text-white">getWalletAddress: {{ getWalletAddress }}</div>
      <div class="text-white">getSolanaWalletType: {{ getSolanaWalletType }}</div>
      <div class="text-white">getSolanaWalletAddress: {{ getSolanaWalletAddress }}</div>
      ...
      <!-- <div class="text-white">solana address</div> -->
      <!-- <div class="text-white">{{ getSolanaWalletAddress }}</div> -->
      <div class="text-center">
        <q-btn @click="goPage(1)" label="Go" color="green" no-caps style="width: 10%; z-index: 9999;" />
      </div>
      ...
      <div class="contents">
        <div class="title">
          <div>
            ...
            <p>BUMI BAND NFT</p>
            <p>
              <q-btn v-if="!getSolanaWalletAddress" @click="connectPhantomWallet()" label="" no-caps rounded class="solana_wallet" style="width: 250px; z-index: 9999;">
                <img src="images/wallet_icon.png" class="text-left">&nbsp;&nbsp;&nbsp;Connect Phantom
              </q-btn>
              <q-btn v-else @click="disconnectPhantomWallet()" label="" no-caps rounded class="solana_wallet" style="width: 250px; z-index: 9999;">
                <img src="images/wallet_icon.png" class="text-left">&nbsp;&nbsp;&nbsp;{{ getSolanaWalletAddressLast }}
              </q-btn>
            </p>
          </div>
        </div>
                ...
                <div class="inner">
                  ...
                  <div class="payment">
                    ...
                    <div class="ck_box">
                      ...
                      <p>
                        <label for="BBSC_1">
                          <input type="radio" name="coin" id="BBSC_1" value="2" v-model="a_mintCurrencySymbolIndex" @click="getTokenAmount(0, 2)">
                          <span></span>
                          BBSC
                        </label>
                      </p>
                  ...
                  <button 
                    ...
                    :disabled="nftTypeList[3]?.amount_remain === 0 || !isButtonActive"
                  >
                  MINT
                  </button>
                </div>
                ...
                <div class="inner">
                  ...
                  <div class="payment">
                    ...
                    <div class="ck_box">
                      ...
                      <p>
                        <label for="BBSC_2">
                          <input type="radio" name="coin" id="BBSC_2" value="2" v-model="s_mintCurrencySymbolIndex" @click="getTokenAmount(1, 2)">
                          <span></span>
                          BBSC
                        </label>
                      </p>
                ...
                <div class="inner">
                  ...
                  <div class="payment">
                    ...
                    <div class="ck_box">
                      ...
                      <p>
                        <label for="BBSC_3">
                          <input type="radio" name="coin" id="BBSC_3" value="2" v-model="r_mintCurrencySymbolIndex" @click="getTokenAmount(2, 2)">
                          <span></span>
                          BBSC
                        </label>
                      </p>
                ...
                <div class="inner">
                  ...
                  <div class="payment">
                    ...
                    <div class="ck_box">
                      ...
                      <p>
                        <label for="BBSC_4">
                          <input type="radio" name="coin" id="BBSC_4" value="2" v-model="v_mintCurrencySymbolIndex" @click="getTokenAmount(3, 2)">
                          <span></span>
                          BBSC
                        </label>
                      </p>
...
export default defineComponent({
  ...
  methods: {
    ...
    showMintingModal() {
      ...
      console.log(this.payCurrencySymbol + '!!!!!!!!!!!!!!')
    ...
    handleDoMinting(data) {
      // this.quantityA = data.quantityA
      // this.quantityS = data.quantityS
      // this.quantityR = data.quantityR
      // this.quantityV = data.quantityV
    ...
    async doPayment() {
      ...
      try {
        // 1. 결제 처리
        const paymentReturnVo = await this.transferBNBCoin(nftPriceVo.currency_contract, this.payCurrencyAmountTotal, this.projectVo.admin_wallet_address)
        ...
        const paramPayment = {
          ...
          wallet_address_to: this.getSolanaWalletAddress,
          wallet_type_to: this.getSolanaWalletType,
          ...
          price_a: this.modalData.priceA,
          price_s: this.modalData.priceS,
          price_r: this.modalData.priceR,
          price_v: this.modalData.priceV,
          ...
          reg_id: this.getSolanaWalletAddress,
        }
        ...
        if (paymentReturnVo.returnCd == 0) {
          ...
          this.$noti(this.$q, 'returnCd: ' + paymentReturnVo.returnCd + ', returnMsg: ' + paymentReturnVo.returnMsg)
        }
      } catch (e) {
        this.$q.loading.hide() // 로딩 표시 종료
      }
      ...
      if (window.phantom && window.phantom.solana && window.phantom.solana.isPhantom) {
        ...
        const handleConnect = async () => {
          ...
          try {
            ...
            this.$cookie.set('solanaWalletAddress', walletAddress)
            this.$cookie.set('solanaWalletType', 'phantom')
            this.$store.dispatch('setSolanaWalletAddress', walletAddress)
            this.$store.dispatch('setSolanaWalletType', 'phantom')
            localStorage.setItem('SOLANAWALLETADDRESS', walletAddress)
            localStorage.setItem('SOLANAWALLETTYPE', 'phantom')
      ...
      if ('phantom' in window && window.phantom.solana && window.phantom.solana.isPhantom) {
        ...
        provider.on('accountChanged', async (publicKey) => {
          if (publicKey) {
            ...
            this.$cookie.set('solanaWalletAddress', publicKey.toBase58())
            this.$store.dispatch('setSolanaWalletAddress', publicKey.toBase58())
            localStorage.setItem('SOLANAWALLETADDRESS', publicKey.toBase58())
          } else {
            try {
    ...
    async disconnectPhantomWallet() {
      try {
        const provider = this.getPhantomProvider();
        if (provider.solana && provider.isConnected) {
      ...
      this.$store.dispatch('setSolanaWalletAddress', '')
      this.$store.dispatch('setSolanaWalletType', '')
      localStorage.setItem('SOLANAWALLETADDRESS', '')
      localStorage.setItem('SOLANAWALLETTYPE', '')
      this.$cookie.set('solanaWalletAddress', '')
      this.$cookie.set('solanaWalletType', '')
    },
    goPage(index) {
      if (index === 0) {
        this.$router.push('/')
