...
export default boot(({ app }) => {
  ...
  // 메타콩즈 총 공급량
  app.config.globalProperties.$METAKONGZ_TOTAL_SUPPLYY = 9999


  // NFT 민팅 상태
  app.config.globalProperties.$NFT_STATUS_MINT_WAIT = '0'
  app.config.globalProperties.$NFT_STATUS_MINT_PROCESSING = '10'
  app.config.globalProperties.$NFT_STATUS_MINT_FAILED = '5'
  app.config.globalProperties.$NFT_STATUS_MINT_COMPLETED = '20'
  ...
  // app.config.globalProperties.$SOLANA_NETWORK = 'https://lively-restless-reel.solana-devnet.quiknode.pro/9dbee36670eab2258267128780801d97eb6ef68b'    // devnet
